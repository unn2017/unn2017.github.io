...
function c(){
document.getElementById("www_cnn").style.display="none";
}
...
document.writeln("<DIV id=\"www_cnn\" style=\"z-index: "+1e10+"\"> ");
document.writeln("</DIV> ");
var www_cnn=new AdMove("www_cnn");
www_cnn.Run();
